...
public class Aquisition extends SubsystemBase {
    ...
    public DigitalInput noteDetectorAquisition;
    public DigitalInput intakeInSwitch;
    public DigitalInput intakeOutSwitch;
    ...
    */
    ...
    public void periodic() {
        ...
        if (!isIntakeRetracted() && isNoteInAquisition()) {
            stopBoth();
            retractIntake();
        }
        if (isIntakeRetracted() && !isNoteInAquisition()) {
    ...
    public boolean isNoteInAquisition() {
