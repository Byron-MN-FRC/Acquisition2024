...
final JoystickButton btnSpampIntake = new JoystickButton(driver.getHID(), XboxController.Button.kX.value);        
...
btnStartSpeaker.onTrue(new ShootHighSpeakerStart( m_spamp ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
 // final JoystickButton btnRetractIntake = new JoystickButton(driver.getHID(), XboxController.Button.kStart.value);     
 ...
 //  final JoystickButton btnRunAcquisition = new JoystickButton(driver.getHID(), XboxController.Button.kStart.value);        
